...
namespace Lz.Web.Dal
{
	...
	public partial class HKSJ_Relationship
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Lz.Web.Model.HKSJ_Relationship model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Lz.Web.Model.HKSJ_Relationship model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Lz.Web.Model.HKSJ_Relationship GetModel(int ID)
		{
			...
			Lz.Web.Model.HKSJ_Relationship model=new Lz.Web.Model.HKSJ_Relationship();
		...
		/// 得到一个对象实体
		/// </summary>
		public Lz.Web.Model.HKSJ_Relationship DataRowToModel(DataRow row)
		{
			Lz.Web.Model.HKSJ_Relationship model=new Lz.Web.Model.HKSJ_Relationship();
			if (row != null)
			{
				...
				if(row["QQ_MSN"]!=null)
				{
					model.QQ_MSN=row["QQ_MSN"].ToString();
				}
