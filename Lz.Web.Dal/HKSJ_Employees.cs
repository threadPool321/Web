...
namespace Lz.Web.Dal
{
	...
	public partial class HKSJ_Employees
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "HKSJ_Employees"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from HKSJ_Employees");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from HKSJ_Employees ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		public Lz.Web.Model.HKSJ_Employees GetModel(int ID)
		{
			...
			Lz.Web.Model.HKSJ_Employees model=new Lz.Web.Model.HKSJ_Employees();
		...
		/// 得到一个对象实体
		/// </summary>
		public Lz.Web.Model.HKSJ_Employees DataRowToModel(DataRow row)
		{
			Lz.Web.Model.HKSJ_Employees model=new Lz.Web.Model.HKSJ_Employees();
			if (row != null)
			{
				...
				if(row["MainPeople"]!=null)
				{
					model.MainPeople=row["MainPeople"].ToString();
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,title,content,people,date,status,MainPeople ");
			strSql.Append(" FROM HKSJ_Employees ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,title,content,people,date,status,MainPeople ");
			strSql.Append(" FROM HKSJ_Employees ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from HKSJ_Employees T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "HKSJ_Employees";
