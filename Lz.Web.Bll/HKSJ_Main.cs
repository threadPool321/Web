...
namespace Lz.Web.Bll
{
    ...
    {
        private readonly Lz.Web.Dal.HKSJ_Main dal = new Lz.Web.Dal.HKSJ_Main();
        public HKSJ_Main()
        { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Lz.Web.Model.HKSJ_Main GetModelByCache(int ID)
        {
            ...
            return (Lz.Web.Model.HKSJ_Main)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Lz.Web.Model.HKSJ_Main> GetModelList(string strWhere)
        {
